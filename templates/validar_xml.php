...
<nav class="primary-nav" role="navigation" aria-label="Navegación principal">
    ...
    <div class="nav-links">
        ...
        <a class="nav-link is-active" href="validar_xml.php"><i class="fas fa-check-circle" aria-hidden="true"></i> Validar</a>
    </div>
</nav>
...
<div class="tool-output">
    ...
    <div class="tool-output-actions">
      ...
      <a href="validar_xml.php" class="btn-secondary"><i class="fas fa-redo"></i> Subir más archivos</a>
    </div>
</div>
<?php endif; ?>
</section>
